  ...
  return (
    <>
      ...
      <div className="flex flex-col h-screen w-screen justify-center items-center ">
        ...
        <h1 className="mb-1 text-white text-5xl sm:text-left md:text-center lg:text-center xl:text-center leading-snug md:leading-normal md:text-5xl lg:text-6xl xl:text-7xl font-poppins px-8 z-10 pb-20  md:pb-48  lg:pb-48  xl:pb-48 font-light font-poppins ">
        ...
        <img
          ...
          src="/div.png"
          className="cursor-pointer align-middle md:w-3/12 md:h-[130px] lg:h-32 xl:h-32 pb-16 z-10  px-8  "
          alt="no"
        ></img>
      </div>
      ...
      <Footer></Footer>
      <div className="h-70 bg-[#42FFC9] opacity-80 flex justify-center items-center text-black font-bold">
        HotKeys
      </div>
    </>
  );
