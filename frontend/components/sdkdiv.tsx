  ...
  return (
    ...
    >
      ...
      <div className="rounded-xl w-4/5 md:w-5/12 lg:w-5/12 xl:w-5/12 h-full bg-[#121212] ">
        <Image src="/code.png " alt="code"></Image>
      </div>
      <div className="rounded-xl w-4/5 md:w-5/12 lg:w-5/12 xl:w-5/12  h-full ">
        ...
        <div className="rounded-xl bg-[#121212]">
          <Stack justify="center" align="center">
            <h1 className="text-white text-center text-poppins font-normal pt-10  pb-6 opacity-80 text-xl md:text-2xl lg:text-4xl xl:text-4xl ">
              no devnet funds?
              <span className="text-white text-center text-poppins font-bold pt-10 text-xl md:text-2xl lg:text-4xl xl:text-4xl pb-6  px-1 md:px-3 lg:px-3 xl:px-3  ">
                get some airdropped.
              </span>
              🛠️
            </h1>
